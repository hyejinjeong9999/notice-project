...
public class QNotice extends EntityPathBase<Notice> {
    ...
    private static final long serialVersionUID = -2097322786L;
    ...
    public final com.rsupport.noticeproject.user.entity.QUser user;
    ...
    public QNotice(Class<? extends Notice> type, PathMetadata metadata, PathInits inits) {
        ...
        this.user = inits.isInitialized("user") ? new com.rsupport.noticeproject.user.entity.QUser(forProperty("user")) : null;
    }
